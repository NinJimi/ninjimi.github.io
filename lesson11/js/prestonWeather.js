const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5604473&units=imperial&appid=9e918bd1e21cabf7a4c4b3edec366c4f"
fetch(apiURL)
...
const fiveDay = "https://api.openweathermap.org/data/2.5/forecast?id=5604473&units=imperial&appid=9e918bd1e21cabf7a4c4b3edec366c4f"
fetch(fiveDay)
.then((response) => response.json())
.then((jsObject) => {
    console.log(jsObject);
